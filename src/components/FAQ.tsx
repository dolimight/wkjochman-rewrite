...
const faqs: CardProps[] = [
  {
    ...
    description:
      "If a plus one is listed on your invite and when you RSVP, then yes! Otherwise we want to keep the wedding an with just friends and family ❤️",
  },
  {
  ...
  },
  {
    ...
    description:
      "The ceremony will be held at Trinity Lutheran Church in Kiel, WI (Address). Cocktail Hour, Dinner, and Reception will be held at the DeBruin Household in New Holstein, WI (Address) The ceremony will be held indoors, whereas the cocktail hour, dinner, and reception will be outside.",
  },
  {
  ...
  },
  {
    ...
    description:
      "We would love to see our family and friends get dressed up with us! We are requesting a semi-formal dress code for the evening. Wear whatever color you'd like, but please no white.",
  },
  {
