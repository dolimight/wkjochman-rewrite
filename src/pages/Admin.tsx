      ...
      <div className="overflow-y-auto">
        <div className="stats my-4 shadow">
          ...
          <div className="stat place-items-center max-sm:hidden">
            <div className="stat-title max-sm:text-xs">Coming To All</div>
            <div className="stat-value max-sm:text-2xl">
          ...
          <div className="stat place-items-center">
            <div className="stat-title max-sm:text-xs">Hasn't Responded</div>
            <div className="stat-value max-sm:text-2xl">
              {rsvpDetails.hasNotResponded.flatMap(getPeople).length}
            </div>
          </div>
        </div>
      </div>
